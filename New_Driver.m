...
nh_normal_result = zeros(3, nNode);
for ii = 1 : 3
    for jj = 1 : nNode
        nh_normal_result(ii, jj) = nh_normal(ID(ii, jj));
    end
end
...
nh_mcn_result = zeros(3, nNode);
for ii = 1 : 3
    for jj = 1 : nNode
        nh_mcn_result(ii, jj) = nh_mcn(ID(ii, jj));
    end
end


nh_result = nh_mcn_result;
